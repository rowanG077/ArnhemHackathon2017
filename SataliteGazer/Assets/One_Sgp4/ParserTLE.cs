      ...
      */
        ...
        */
            ...
            string tleName = null)
        {
            ...
            epochDay = double.Parse(epDay, culture);

			firstMeanMotion = double.Parse(line1[4 + noID], culture);
            ...
            if (line1[5 + noID].Length > 0)
            {
                ...
                secondMeanMotion = double.Parse(line1[5 + noID], culture);
            }
            else
            {
            ...
            if (line1[6 + noID].Length > 0)
            {
                ...
                dragTerm = double.Parse(line1[6 + noID], culture);
            }
            else
            {
                dragTerm = 0.0;
            ...
            ephemeris = double.Parse(line1[7 + noID], culture);
            ...
            inclination = double.Parse(line2[2], culture);
            rightAscension = double.Parse(line2[3], culture);
            line2[4] = line2[4].Insert(0, ".");
            eccentricity = double.Parse(line2[4], culture);
            perigee = double.Parse(line2[5], culture);
            meanAnomoly = double.Parse(line2[6], culture);
            if (line2[8] != null )
            {
                meanMotion = double.Parse(line2[7], culture);
        ...
        */
        public static List<Tle> ParseString(string str)
        {
			return str
				...
				.Where(x => x.Count == 3)
				.Select(x => parseTle(x.ElementAt(1), x.ElementAt(2), x.ElementAt(0)))
				.ToList();
        }
